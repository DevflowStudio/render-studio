...
// /// ),
// /// ```
// class RenderNavigationBar extends StatelessWidget {
...
// 
//   /// The z-coordinate of this [RenderNavigationBar].
//   final double elevation;
// 
//   /// The color of the [RenderNavigationBar] itself.
//   ///
//   /// If null, defaults to [ColorScheme.surface].
//   final Color? backgroundColor;
// 
//   /// The height of the [RenderNavigationBar]'s Material, from the bottom of the
...
//     final ColorScheme colorScheme = Palette.of(context);
...
// /// Navigation Bars through [RenderNavigationBar.destinations].
// ///
...
//   /// in the [RenderNavigationBar.destinations].
...
//     final Animation<double> animation = NavigationBarDestinationInfo.of(context).selectedAnimation;
// 
...
//           icon,
//           size: 24,
//           color: Palette.of(context).onSecondary,
//         );
...
//   /// Builds a destination (icon + label) to use in a Material 3 [RenderNavigationBar].
...
//   }) : super(key: key);
// 
//   /// Builds the icon for an destination in a [RenderNavigationBar].
//   ///
...
// 
//   /// Builds the label for an destination in a [RenderNavigationBar].
//   ///
//   /// To animate between unselected and selected, build the icon based on
...
// /// [RenderNavigationBar] by default).
// ///
...
// }
// 
// /// Tooltip widget for use in a [RenderNavigationBar].
// ///
...
// }
// 
// /// Inherited widget for passing data from the [RenderNavigationBar] to the
// /// [RenderNavigationBar.destinations] children widgets.
// ///
...
//   ///
//   /// This is computed by calling [RenderNavigationBar.onTap] with [destinationNumber]
//   /// passed in.
...
//       'usually provided by RenderNavigationBar.',
//     );
//     return result!;
//   }
// 
