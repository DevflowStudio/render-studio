...
class _AutoSizeTextState extends State<AutoSizeText> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, size) {
      ...
      if (widget.group != null) {
        ...
        __fontSize = widget.group!._fontSize;
      } else {
        __fontSize = fontSize;
      }
  ...
  void _validateProperties(TextStyle style, int? maxLines) {
    ...
    if (widget.presetFontSizes == null) {
      ...
      if (widget.maxFontSize != double.infinity) assert(widget.maxFontSize / widget.stepGranularity % 1 == 0, 'MaxFontSize must be a multiple of stepGranularity.');
    } else {
